#!/bin/bash
#PBS -N FastimCoal2_besckei-ethilla_IM
...
# Scenario 
PREFIX=IM
DATADIR=/storage/brno12-cerit/home/repulles/03.Heliconius/13.fsc2
input=/storage/brno12-cerit/home/repulles/03.Heliconius/07.SFS_VCF
out=$DATADIR/bes.eth

file=$input/Allsamples_nowallacei_Allsites_GENOME_jointMAFpop2_1.obs
