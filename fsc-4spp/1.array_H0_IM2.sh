#!/bin/bash
#PBS -N FastimCoal2_H0_IM_4demes
#PBS -l select=1:ncpus=14:mem=2gb:scratch_local=10gb
...
out=$DATADIR/H0_IM_4demes_Tdivconstrained
...
do
  ...
  fsc27093 -t ${PREFIX}.tpl -n 500000 -m -e ${PREFIX}.est -M -L 50 -q -c 14 --numBatches 14 --multiSFS 
