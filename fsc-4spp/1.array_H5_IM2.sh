#!/bin/bash
#PBS -N FastimCoal2_H5_IM_4demes
#PBS -l select=1:ncpus=16:mem=2gb:scratch_local=20gb
...
do
  ...
  fsc27093 -t ${PREFIX}.tpl -n 500000 -m -e ${PREFIX}.est -M -L 50 -q -c 16 --numBatches 16 --multiSFS 
  cd ..
